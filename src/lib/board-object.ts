...
export const STICKY_DEFAULT_COLOR = '#FFEB3B';
export const RECT_DEFAULT_COLOR = '#E3F2FD';
export const RECT_DEFAULT_STROKE = '#1565C0';
...
export const CIRCLE_DEFAULT_COLOR = '#E0F2FE';
export const LINE_DEFAULT_COLOR = '#0F172A';
export const FRAME_DEFAULT_STROKE = '#334155';
