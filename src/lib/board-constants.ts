...
export const CONNECTOR_HANDLE_STROKE = '#2563eb';
...
export const CONNECTOR_LABEL_FONT_FAMILY = 'Segoe UI, sans-serif';
...
export const CONNECTOR_LABEL_BACKGROUND_STROKE = 'rgba(148, 163, 184, 0.45)';
export const BOARD_HISTORY_MAX_ENTRIES = 100;
export const FRAME_HIGHLIGHT_STROKE = '#3B82F6';
