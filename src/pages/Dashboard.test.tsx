...
describe('Dashboard', () => {
  ...
  it('opens the top owned-case search result when Enter is pressed', () => {
    renderDashboard({}, {
      boards: [
  ...
  it('opens the top shared-case search result when Enter is pressed', () => {
    renderDashboard(
      {},
      {},
      {
  ...
  it('does not navigate from search when Enter is pressed with no matching cases', () => {
    renderDashboard({}, {
      boards: [
        { id: 'owned-1', title: 'Smith v. Acme', ownerId: 'user-123', createdAtMs: 1000, updatedAtMs: 3000 },
      ],
