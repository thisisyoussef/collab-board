...
describe('Dashboard', () => {
  ...
  it('shows "Can edit" badge for explicit editor access', () => {
    renderDashboard(
      {},
      {},
      {
  ...
  it('shows "View only" badge for explicit viewer access', () => {
    renderDashboard(
      {},
      {},
      {
  ...
  it('shows "Opened via link" badge for recent shared links', () => {
    renderDashboard(
      {},
      {},
      {
