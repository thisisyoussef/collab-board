...
| US-03 | fa0bd1c | https://collab-board-iota.vercel.app | https://collab-board-0948.onrender.com | lint+test+build pass | Pending | In Progress | Presence room flow + topbar avatars implemented (`join-board`, `presence:snapshot`, `user:joined`, `user:left`); pushed to `main` for Vercel/Render auto-deploy and waiting for manual multi-tab checkpoint. |
| US-04 |  |  |  |  |  | Pending |  |
| US-05 |  |  |  |  |  | Pending |  |
| US-06 |  |  |  |  |  | Pending |  |
| US-07 |  |  |  |  |  | Pending |  |
