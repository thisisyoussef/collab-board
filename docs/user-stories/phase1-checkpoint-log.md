...
| US-05 | 607362f | https://collab-board-iota.vercel.app | https://collab-board-0948.onrender.com | lint+test+build pass | Pending | In Progress | Local canvas CRUD + Firestore debounced persistence implemented; Vercel production verified with updated asset hash (`index-ljYJuHw0.css`). |
| US-06 |  |  |  |  |  | Pending |  |
| US-07 |  |  |  |  |  | Pending |  |
