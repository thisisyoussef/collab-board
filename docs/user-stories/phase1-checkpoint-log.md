...
| US-04 | Uncommitted | https://collab-board-iota.vercel.app | https://collab-board-0948.onrender.com | lint+test+build pass | Pending | In Progress | Cursor sync implemented with Socket.IO volatile transport, Konva remote cursor layer, 50ms client throttle, and latency metrics overlay; awaiting deployment confirmation and manual two-browser checkpoint. |
| US-05 |  |  |  |  |  | Pending |  |
| US-06 |  |  |  |  |  | Pending |  |
| US-07 |  |  |  |  |  | Pending |  |
