...
| US-04 | 99e5571 | https://collab-board-iota.vercel.app | https://collab-board-0948.onrender.com | lint+test+build pass | Pending | In Progress | Cursor sync implemented with Socket.IO volatile transport, Konva remote cursor layer, 50ms client throttle, and latency metrics overlay; pushed to `main` and manually deployed to Vercel production alias; waiting for manual two-browser checkpoint. |
| US-05 |  |  |  |  |  | Pending |  |
| US-06 |  |  |  |  |  | Pending |  |
| US-07 |  |  |  |  |  | Pending |  |
